...
INSERT INTO usuarios (email,senha) VALUES ('adm@gmail','321'), ('cliente@gmail','123'), ('farmacia@gmail', '123');
...
('20031-050', 'RJ', 'Rio de Janeiro', 'Avenida das Farmácias', 250, 'Copacabana', 'Em frente à praça principal'), ('00000-000', 'DF', 'Brasília', 'AS15', 150, 'Asa Sul', 'Próximo à estação de metrô');
...
INSERT INTO clientes (nome, cpf, telefone, data_nascimento, endereco_id, usuario_id) VALUES ('cliente teste', '11111111111','22222222222','2000-01-01',1,2);
...
INSERT INTO farmacias (nome_juridico,nome_fantasia,cnpj,alvara_sanitario,responsavel_tecnico,crf,telefone,endereco_id, usuario_id) VALUES ('Farmácia Saúde Total LTDA','Farmácia Saúde Total','12345678000199','ALV-2025-0001','João da Silva','CRF-SP 12345','11999990000',2, 3);
...
('Dipirona Sódica 500mg', 'Analgésico e antipirético em comprimidos.', 100, FALSE, 12.90, 2, 1),
('Paracetamol 750mg', 'Analgésico e antipirético em comprimidos.', 80, TRUE, 15.50, 2, 1),
('Shampoo Anticaspa 200ml', 'Shampoo para controle de caspa.', 50, FALSE, 22.90, 1, 1),
('Sabonete Líquido Neutro 250ml', 'Sabonete líquido para uso diário.', 70, FALSE, 14.75, 4, 1),
('Protetor Solar FPS 50 120ml', 'Protetor solar para todos os tipos de pele.', 40, TRUE, 49.90, 3, 1),
('Vitamina C 500mg', 'Suplemento vitamínico em comprimidos.', 60, FALSE, 29.90, 6, 1),
('Fralda Infantil Tamanho M', 'Pacote com 30 unidades.', 35, FALSE, 39.99, 5, 1),
('Álcool 70% 500ml', 'Álcool etílico 70% para assepsia.', 90, TRUE, 9.99, 6, 1),
('Escova Dental Macia', 'Escova dental com cerdas macias.', 120, FALSE, 7.50, 4, 1),
('Creme Hidratante Corporal 200ml', 'Hidratante corporal para pele seca.', 55, FALSE, 24.90, 1, 1);
